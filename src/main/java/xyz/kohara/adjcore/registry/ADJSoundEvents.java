...
public class ADJSoundEvents {
    ...
    public static final SoundType ICE = new ForgeSoundType(1f, 1f,
            ADJSoundEvents.ICE_BREAK, ADJSoundEvents.ICE_STEP,
            ADJSoundEvents.ICE_PLACE, ADJSoundEvents.ICE_HIT,
            ADJSoundEvents.ICE_FALL);

    public static final SoundType GOURD = new ForgeSoundType(1f, 1f,
            ADJSoundEvents.GOURD_BREAK, ADJSoundEvents.GOURD_STEP,
            ADJSoundEvents.GOURD_PLACE, ADJSoundEvents.GOURD_HIT,
            ADJSoundEvents.GOURD_FALL);

    public static final SoundType SHULKER_BOX = new ForgeSoundType(1f, 1f,
            ADJSoundEvents.SHULKER_BOX_BREAK, ADJSoundEvents.SHULKER_BOX_STEP,
            ADJSoundEvents.SHULKER_BOX_PLACE, ADJSoundEvents.SHULKER_BOX_HIT,
            ADJSoundEvents.SHULKER_BOX_FALL);

    public static final SoundType SPAWNER = new ForgeSoundType(1f, 1f,
            ADJSoundEvents.SPAWNER_BREAK, () -> SoundEvents.NETHERITE_BLOCK_STEP,
    ...
    public static final SoundType PURPUR = new ForgeSoundType(1f, 1f,
            ADJSoundEvents.PURPUR_BREAK, ADJSoundEvents.PURPUR_STEP,
            ADJSoundEvents.PURPUR_PLACE, ADJSoundEvents.PURPUR_HIT,
            ADJSoundEvents.PURPUR_FALL);

    public static final SoundType CHORUS_PLANT = new ForgeSoundType(1f, 1f,
            ADJSoundEvents.CHORUS_PLANT_BREAK, ADJSoundEvents.CHORUS_PLANT_STEP,
            ADJSoundEvents.CHORUS_PLANT_PLACE, ADJSoundEvents.CHORUS_PLANT_HIT,
            ADJSoundEvents.CHORUS_PLANT_FALL);
